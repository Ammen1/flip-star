...
class OTPService:
    ...
    @classmethod
    def send_otp(cls, phone_number, application_key, product_number='10000302850', action='verification'):
        ...
        """
        print(f"[OTP SERVICE DEBUG] send_otp called for phone: {phone_number}, app_key: {application_key}, product_number: {product_number}, action: {action}")
