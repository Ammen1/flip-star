  ...
  async function saveConfig() {
    try {
      ...
      const flat = {
        ...
        cost_post_create_non_campaign: config.costs.post_create_non_campaign,
        cost_like_non_campaign: config.costs.like_non_campaign,
        cost_comment_non_campaign: config.costs.comment_non_campaign,
        cost_share_non_campaign: config.costs.share_non_campaign,
        cost_gift_non_campaign: config.costs.gift_non_campaign,
        cost_boost_1hr_non_campaign: config.costs.boost_1hr_non_campaign,
        cost_boost_2hr_non_campaign: config.costs.boost_2hr_non_campaign,
        cost_boost_24hr_non_campaign: config.costs.boost_24hr_non_campaign,
        cost_trending_1hr_non_campaign: config.costs.trending_1hr_non_campaign,
        cost_trending_24hr_non_campaign: config.costs.trending_24hr_non_campaign,
