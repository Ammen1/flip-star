...
export function RegisterScreen({ onSuccess, onLogin, onBack }) {
  ...
  const [form, setForm] = useState({ name:"", pw:"", phone:"", country:"+251" });
  ...
  const finish = async () => {
    ...
    try {
      ...
      console.log('Registering with:', { username, firstName, lastName, password: form.pw, phone: fullPhone });
