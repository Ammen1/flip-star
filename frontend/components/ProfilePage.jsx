        ...
        <>
          ...
          <div style={{ position: "sticky", top: 0, zIndex: 10 }}>
            ...
            <div style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 16, fontWeight: 700, color: '#8fc441' }}>
        ...
        >
          ...
          >
            ...
            <button onClick={() => setShowReportUser(false)}
              style={{ marginTop: 12, width: '100%', padding: 12, border: 'none', borderRadius: 10, background: 'rgba(249,224,139,0.15)', cursor: 'pointer', fontSize: 14, fontWeight: 600, color: '#8fc441' }}>
              Cancel
            </button>
          </div>
        </div>
