...
function IconWrap({ children }) {
  return (
    <div style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", color: "#b8d97a", display: "flex" }}>
      {children}
    </div>
  );
}
...
function Field({ label, icon, children }) {
  return (
    <div style={{ marginBottom: 16 }}>
      <label style={{ display: "block", fontSize: 12, fontWeight: 700, color: "#b8d97a", marginBottom: 7, letterSpacing: 0.5 }}>
        {label}
      </label>
...
function StepDot({ active, done }) {
  return (
    <div style={{
      ...
      borderRadius: "50%",
      background: done ? "#b8d97a" : active ? GOLD : "#262626",
    ...
    <div style={wrap}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 28 }}>
          ...
          <div style={{ width: 48, height: 2, background: step > 1 ? "#b8d97a" : "#262626", borderRadius: 1, transition: "background 0.3s" }} />
        ...
        <div style={{ background: T.cardBg || "#1A1A1A", borderRadius: 18, padding: "28px 24px", border: "1px solid #b8d97a30" }}>
          ...
          {step === 1 && (
            <>
              <div style={{ textAlign: "center", marginBottom: 24 }}>
                ...
                <div style={{ fontSize: 22, fontWeight: 900, color: "#b8d97a", marginBottom: 4 }}>Create Account</div>
                <div style={{ fontSize: 13, color: "#b8d97a" }}>Fill in your details to get started</div>
              </div>
              <ErrorBox msg={error} />
          ...
          {step === 2 && (
            <>
              <div style={{ textAlign: "center", marginBottom: 16 }}>
                <div style={{ fontSize: 36, marginBottom: 8 }}>🔐</div>
                <div style={{ fontSize: 22, fontWeight: 900, color: "#b8d97a", marginBottom: 4 }}>Verify Code</div>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <button onClick={() => { setStep(1); setOtp(""); setError(""); setDevCode(""); }}
                  style={{ background: "none", border: "none", color: "#b8d97a", fontSize: 13, cursor: "pointer", display: "flex", alignItems: "center", gap: 4 }}>
                  <ChevronLeft size={14} /> Go back
                </button>
                {resendTimer > 0 ? (
                  <span style={{ color: "#666", fontSize: 12 }}>Resend in {resendTimer}s</span>
                ) : (
                  <button onClick={handleSendOtp} style={{ background: "none", border: "none", color: "#b8d97a", fontSize: 13, fontWeight: 700, cursor: "pointer" }}>
                    Resend OTP
                  </button>
                )}
              </div>
          ...
          <div style={{ textAlign: "center", fontSize: 13, color: "#666", marginTop: 4 }}>
            ...
            <button onClick={onLogin} style={{ background: "none", border: "none", color: "#b8d97a", fontWeight: 700, cursor: "pointer", fontSize: 13 }}>
              Log in
            </button>
          </div>
        </div>
