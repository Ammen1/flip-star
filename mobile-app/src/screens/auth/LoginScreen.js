      ...
      <View style={[s.modalOverlay, { justifyContent: 'flex-start' }]}>
        <View style={[s.modalSheet, { maxHeight: '100%', minHeight: '100%', borderRadius: 0, paddingTop: 48 }]}>
          ...
          <ScrollView showsVerticalScrollIndicator={false} style={{ padding: 4 }}>
            ...
            <Text style={ts.subSectionTitle}>3.5 Charging Logic</Text>
            ...
            <Text style={ts.subSectionTitle}>3.7 Unsubscription</Text>
            ...
            <Text style={ts.bullet}>• To unsubscribe via app or web: use the unsubscription option within the app or web portal under Account Settings.</Text>
