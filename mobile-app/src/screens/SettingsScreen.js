        ...
        <View style={[styles.modalOverlay, { justifyContent: 'flex-start' }]}>
          <View style={[styles.modalSheet, { maxHeight: '100%', minHeight: '100%', borderRadius: 0, paddingTop: 48 }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ padding: 4 }}>
              ...
              <Text style={styles.bullet}>• FlipStar is available to all active Ethio Telecom prepaid, postpaid, and hybrid mobile customers with a smartphone device (Android, iOS, or any HTML5-capable browser for web access).</Text>
              ...
              <Text style={styles.bullet}>• To subscribe via SMS: send 'OK1' (Daily), 'OK2' (Weekly), or 'OK3' (Monthly) to the FlipStar shortcode. To unsubscribe: send 'STOP1', 'STOP2', or 'STOP3' to the same shortcode.</Text>
              ...
              <Text style={styles.bullet}>• Daily Plan: 3 ETB per day - Charged daily. Auto-renewed while active.</Text>
              <Text style={styles.bullet}>• Weekly Plan: 20 ETB per week - Charged weekly. Auto-renewed while active.</Text>
              <Text style={styles.bullet}>• Monthly Plan: 70 ETB per month - Charged monthly. Auto-renewed while active.</Text>
              <Text style={styles.bullet}>• On-Demand Plan: 10 ETB for 100 Coins - One-time purchase. No recurring charge.</Text>
              ...
              <Text style={styles.subSectionTitle}>3.3 Free Trial</Text>
              ...
              <Text style={styles.subSectionTitle}>3.4 Charging Logic</Text>
              ...
              <Text style={styles.bullet}>• Failed billing attempts will be retried automatically per Ethio Telecom MA time standards, or if the customer recharges their balance within the same day.</Text>
              <Text style={styles.bullet}>• The service will be activated automatically after a successful subscription or payment.</Text>
              <Text style={styles.subSectionTitle}>3.5 Auto-Renewal</Text>
              ...
              <Text style={styles.subSectionTitle}>3.6 Unsubscription</Text>
              <Text style={styles.bullet}>• To unsubscribe, send 'STOP1', 'STOP2', or 'STOP3' to the FlipStar shortcode, or use the unsubscription option within the app or web portal under Account Settings.</Text>
              ...
              {/* 5 */}
              <Text style={styles.sectionTitle}>5. Digital Coins and the Creator Economy</Text>
              ...
              <Text style={styles.bullet}>• Purchase coins via telebirr or Airtime. No commission at purchase.</Text>
              <Text style={styles.bullet}>• On-Demand Pack: 10 ETB = 100 Coins (Flip On-Demand purchase).</Text>
              <Text style={styles.bullet}>• Daily login bonus: 3 Coins per day for opening the FlipStar app.</Text>
              <Text style={styles.bullet}>• Weekly loyalty bonus: 50 Coins for consistent daily usage for a full week.</Text>
              <Text style={styles.bullet}>• Gift a creator: Convert Coins into virtual Gifts sent to other users' content.</Text>
              <Text style={styles.bullet}>• Creator earns Points: 1 Coin gifted = 1 Point earned (100% of gift value).</Text>
              <Text style={styles.bullet}>• Cash out Points: 10 Points = 0.8 ETB (20% platform commission at payout).</Text>
              <Text style={styles.bullet}>• Re-invest Points: 1 Point = 1 Coin (swap Points back to Coins for in-app spending).</Text>
              <Text style={styles.bullet}>• Min. cash-out: 1,000 Points (80 ETB net after commission) required for telebirr payout.</Text>
              <Text style={styles.subSectionTitle}>5.2 Coin Rules</Text>
              ...
              <Text style={styles.bullet}>• Coins earned via daily bonuses and loyalty rewards may not be cashed out — they may only be spent within the platform (gifting, boosts, etc.).</Text>
              ...
              <Text style={styles.bullet}>• Standard subscriber: 15 – 60 seconds - Available to all active subscribers.</Text>
              <Text style={styles.bullet}>• Coin buyer (On-Demand / Premium): Up to 90–120 seconds - Unlocked by purchasing coins or on-demand packs.</Text>
              ...
              <Text style={styles.bullet}>Score = (Likes × 1) + (Comments × 2) + (Shares × 5) + (Gift/Vote Points × 10)</Text>
              ...
              <Text style={styles.bullet}>• Daily Sprint: 50 winners - 1 GB Daily Data - Credited to telebirr/account within 24 hours.</Text>
              <Text style={styles.bullet}>• Weekly Battle: 10 winners - 1,000 ETB - Via telebirr within 10 days.</Text>
              <Text style={styles.bullet}>• Monthly Star: 5 winners - 10,000 ETB - Via telebirr within 10 days.</Text>
              <Text style={styles.bullet}>• Grand Final — 1st (Legend): 1 winner - 500,000 ETB - Within 20 days. Winner contacted by phone.</Text>
              <Text style={styles.bullet}>• Grand Final — 2nd (Icon): 1 winner - 300,000 ETB - Within 20 days. Winner contacted by phone.</Text>
              <Text style={styles.bullet}>• Grand Final — 3rd (Spark): 1 winner - 200,000 ETB - Within 20 days. Winner contacted by phone.</Text>
              <Text style={styles.subSectionTitle}>7.3 Winner Cooldown Rules</Text>
              <Text style={styles.bullet}>• Winners of a specific tier are ineligible to win that same tier again for 30 days from the date of winning.</Text>
              ...
              <Text style={styles.bullet}>• In-App Support: Profile → Help & Support → Contact Us</Text>
              <Text style={styles.bullet}>• Email: support@flipstar.et</Text>
              <Text style={styles.bullet}>• SMS: 8994</Text>
              <Text style={styles.bullet}>• Website: https://www.ethiotelecom.et/</Text>
              <Text style={styles.bullet}>• Email (Ethio Telecom): 994@ethionet.et</Text>
              <Text style={styles.bullet}>• WhatsApp: +251 99 400 0000</Text>
              <Text style={styles.bullet}>• Telegram: https://t.me/ethio_telecom</Text>
