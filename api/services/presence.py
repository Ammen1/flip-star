...
class PresenceService:
    ...
    def __init__(self):
        # Read the connection from Django settings rather than re-reading the
        # environment. settings resolves through environment -> Vault -> .env,
        # so this cannot drift from the channel layer or the Celery broker.
