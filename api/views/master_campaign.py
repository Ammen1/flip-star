...
from api.models.master_campaign import MasterCampaign, MasterCampaignParticipant
from common.security import encrypted_endpoint
from api.serializers.master_campaign import MasterCampaignSerializer, MasterCampaignParticipantSerializer
...
def update_generation_config(request, pk):
    ...
    try:
        ...
        from api.serializers.master_campaign import MasterCampaignSerializer
        serializer = MasterCampaignSerializer(campaign)
        return Response(serializer.data)
