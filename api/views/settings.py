...
from api.models.admin import APIKey, PlatformSettings, SystemLog, PlatformMetrics, AdminNotification
from api.models import Reel, Comment, Vote, Follow, Subscription
...
def get_security_overview(request):
    ...
    from api.models.admin import APIKey
