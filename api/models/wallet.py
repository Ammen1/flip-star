...
class WalletConfig(models.Model):
    ...
    withdrawal_fee_percent = models.DecimalField(max_digits=5, decimal_places=2, default=Decimal('20.00'), help_text='Service fee % on withdrawal')
...
class WithdrawalRequest(models.Model):
    ...
    b2c_transaction_id = models.UUIDField(null=True, blank=True, help_text='Linked B2CPaymentTransaction ID')
    originator_conversation_id = models.CharField(max_length=100, blank=True, help_text='B2C originator conversation ID')
    conversation_id = models.CharField(max_length=100, blank=True, help_text='B2C conversation ID from Telebirr')
    ...
    def mark_rejected(self, admin_user, reason=''):
        ...
        if self.coin_amount:
            ...
            balance.add_earned(
                self.coin_amount, transaction_type='refund',
